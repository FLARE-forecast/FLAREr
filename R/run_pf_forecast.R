#' @title Run Boot Strap filter to assimilate observations and/or produce
#' forecasts
#'
#' @details Uses the Bootstrap Particle filter to predict water quality for a lake
...
#'
#'run_pf_forecast <- flare::run_pf_forecast(states_init = init$states,
#'               pars_init = init$pars,
...
run_pf_forecast <- function(states_init,
                              pars_init = NULL,
                              aux_states_init,
                              obs,
                              obs_sd,
