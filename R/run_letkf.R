...
run_letkf <- function(x_matrix,
  ...
  # psi vector.  The first (length(psi) - n_non_vertical) entries are vertical
  # observations ordered as state-type × depth; non-vertical entries get NA
  # and will receive localization weight = 1 (global update).
  n_vert     <- length(psi) - n_non_vertical
