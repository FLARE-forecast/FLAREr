...
enkf_output <- FLAREr::run_da_forecast(states_init = init$states,
                                       ...
                                       model_sd = model_sd,
                                       working_directory = config$run_config$execute_location,
                                       met_file_names = gsub("\\\\", "/", met_out$filenames),
                                       inflow_file_names = gsub("\\\\", "/", inflow_outflow_files$inflow_file_name),
                                       outflow_file_names = gsub("\\\\", "/", inflow_outflow_files$outflow_file_name),
                                       config = config,
