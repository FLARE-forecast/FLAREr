...
The variable `modeled_depths` allows you to adjust the depths that FLARE simulates.  If you used a restart file, then the `model_depths` are required to be equal to the model_depths in the restart file.
