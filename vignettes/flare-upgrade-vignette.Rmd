...
-   **add_random_noise:** controls how observation perturbations are
    drawn for the stochastic EnKF. Set to `2` (normal distribution
    centred on the observation). If you were previously using the
    default stochastic EnKF this value reproduces the old behaviour.
